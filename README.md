...
- Analysis reports linked to the sweep result CSVs under `results/`.
...
latest sequence feature-family screen, evaluated across the same five model
seeds used for the seed-band check. Detailed per-run outputs are saved in
`results/latest_official_eval_per_run.csv`; the summarized table source is
`results/latest_official_eval_summary.csv`.

Validation RMSE:

| Subset | Ridge | GRU | LSTM |
|---|---:|---:|---:|
| FD001 | 20.29 | 10.39 ± 0.33 | 9.72 ± 0.41 |
| FD002 | 19.35 | 13.08 ± 0.15 | 13.19 ± 0.23 |
| FD003 | 17.05 | 10.46 ± 0.22 | 10.53 ± 0.33 |
| FD004 | 18.45 | 14.96 ± 0.10 | 15.04 ± 0.20 |

Official test set:

| Subset | Ridge RMSE | Ridge PHM08 | GRU RMSE | GRU PHM08 | LSTM RMSE | LSTM PHM08 |
|---|---:|---:|---:|---:|---:|---:|
| FD001 | 20.59 | 1,226 | 13.92 ± 0.21 | 304 ± 20 | 14.97 ± 0.22 | 333 ± 24 |
| FD002 | 31.30 | 17,700 | 24.61 ± 0.43 | 5,055 ± 582 | 25.11 ± 0.59 | 5,495 ± 911 |
| FD003 | 22.80 | 2,531 | 14.06 ± 0.19 | 362 ± 39 | 13.98 ± 0.30 | 332 ± 29 |
| FD004 | 33.06 | 9,528 | 26.05 ± 0.38 | 4,631 ± 493 | 26.16 ± 0.53 | 4,552 ± 386 |
...
results/                              # Sweep and benchmark summary CSVs
