# Shared Training and Evaluation Paths
...
flowchart TD
    ...
    RUNSWEEP["turbofan-regenerate-baselines<br/>(official-eval sweep entrypoint)"] --> OJRIDGE
    RUNSWEEP --> OJSEQ
    RUNSCREEN["turbofan-feature-screen<br/>(experiment entrypoint)"] --> FFSCELL
```
