...
| `../../results/baselines/archive/gru_sweep.csv` | Source data for the above | `results/baselines/stage1_temporal_sweep_*.csv`, `results/baselines/stage2_capacity_sweep_*.csv` | Same lineage. |
...
| `../../results/baselines/archive/feature_sweep_gru_fd00{1-4}.csv` | Source data for the GRU feature sweep | `results/baselines/stage1_temporal_sweep_*.csv` (window/feature selection) | Same lineage; mechanism tables in the report still derive from these. |

The corresponding data CSVs live under [`../../results/baselines/archive/`](../../results/baselines/archive/).
